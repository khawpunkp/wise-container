...
namespace _ComponentCustomProperties {
  ...
  const { baseURL, default: Axios }: typeof import('@/api')
  const { cn }: typeof import('./src/utils/index')
  const { default: axios }: typeof import('axios')
  const { messages }: typeof import('./src/lang/translations')
  const { onBeforeRouteLeave, onBeforeRouteUpdate, useRoute, useRouter }: typeof import('vue-router')
  const { useLang }: typeof import('./src/lang/composable/index')
}
declare module 'vue' {
