...
const socials = [
   { logo: facebook, link: 'https://www.facebook.com/61575234320876' },
...
<template>
   ...
   >
      <div class="mobile:flex-col mobile:px-6 flex w-full items-center justify-between gap-6 px-16">
         ...
         <Typography variant="Caption" class="mobile:flex hidden">
            {{ t('footer.copyright') }}
         </Typography>
      </div>
   </footer>
