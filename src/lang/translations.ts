...
export const messages: Record<Lang, Record<string, string>> = {
   en: {
      ...
      'home.services.construct': 'Warehouse & Container Yard\nConstruction Services',
      ...
      'product.worker.40-5': 'Container House 40 ft. 5 Rooms',
      'product.worker.40-4': 'Container House 40 ft. 4 Rooms',
      'product.worker.40-3': 'Container House 40 ft. 3 Rooms',
      'product.worker.40-2': 'Container House 40 ft. 2 Rooms',
      'product.worker.20-2': 'Container House 20 ft. 2 Rooms',
      'product.worker.20-1': 'Container House 20 ft. 1 Room',
      'product.office': 'Container Office',
      'product.office.40-5': 'Container Office 40 ft. 5 Rooms',
      'product.office.40-4': 'Container Office 40 ft. 4 Rooms',
      'product.office.40-3': 'Container Office 40 ft. 3 Rooms',
      'product.office.40-2': 'Container Office 40 ft. 2 Rooms',
      'product.office.20-2': 'Container Office 20 ft. 2 Rooms',
      'product.office.20-1': 'Container Office 20 ft. 1 Room',
      'product.restroom': 'Container Restroom',
      'product.restroom.1': 'Container Restroom 1 Rooms',
      'product.restroom.2': 'Container Restroom 2 Rooms',
      'product.restroom.3': 'Container Restroom 3 Rooms',
      ...
      'services.construct.title': '24-Hour Agent Container Depot',
      ...
      'services.design.desc':
         'We specialize in designing and fabricating customized containers — from office units and worker housing to portable restrooms and mobile shops.\n\nEach container is built with premium materials and safety standards to ensure durability, functionality, and aesthetic appeal.',
      'services.yard.desc':
      ...
      'services.construct.desc':
         'We provide end-to-end construction services for warehouses and container yards, from design and planning to full build, ensuring strong and reliable.\n\nWe oversee every step through to handover, offering guidance on yard layout and road systems to ensure you receive a high-quality, functional space for your operations.',
      ...
      'work5.title': '20 ft. Container for Sacred Objects',
      'work6.title': '24-Hour Container Transport Service',
      'work7.title': '40 ft. Office Container Divided into 2 Rooms',
   ...
   th: {
      ...
      'home.services.construct': 'บริการรับเหมาก่อสร้าง\nคลังสินค้าและลานตู้',
      ...
      'product.worker.40-5': 'ตู้บ้านพักคนงาน 40 ฟุต 5 ห้อง',
      'product.worker.40-4': 'ตู้บ้านพักคนงาน 40 ฟุต 4 ห้อง',
      'product.worker.40-3': 'ตู้บ้านพักคนงาน 40 ฟุต 3 ห้อง',
      'product.worker.40-2': 'ตู้บ้านพักคนงาน 40 ฟุต 2 ห้อง',
      'product.worker.20-2': 'ตู้บ้านพักคนงาน 20 ฟุต 2 ห้อง',
      'product.worker.20-1': 'ตู้บ้านพักคนงาน 20 ฟุต 1 ห้อง',
      'product.office': 'ตู้ออฟฟิศ',
      'product.office.40-5': 'ตู้ออฟฟิศ 40 ฟุต 5 ห้อง',
      'product.office.40-4': 'ตู้ออฟฟิศ 40 ฟุต 4 ห้อง',
      'product.office.40-3': 'ตู้ออฟฟิศ 40 ฟุต 3 ห้อง',
      'product.office.40-2': 'ตู้ออฟฟิศ 40 ฟุต 2 ห้อง',
      'product.office.20-2': 'ตู้ออฟฟิศ 20 ฟุต 2 ห้อง',
      'product.office.20-1': 'ตู้ออฟฟิศ 20 ฟุต 1 ห้อง',
      'product.restroom': 'ตู้ห้องน้ำ',
      'product.restroom.1': 'ตู้ห้องน้ำ 1 ห้อง',
      'product.restroom.2': 'ตู้ห้องน้ำ 2 ห้อง',
      'product.restroom.3': 'ตู้ห้องน้ำ 3 ห้อง',
      ...
      'services.construct.title': 'บริการรับเหมาก่อสร้างคลังสินค้าและลานตู้',
      'services.trade.desc':
      ...
      'services.construct.desc':
         'ให้บริการรับเหมาก่อสร้างคลังสินค้าและลานตู้ครบวงจร ตั้งแต่ออกแบบ วางผัง ไปจนถึงก่อสร้างจริง โดยทีมงานมืออาชีพ มุ่งเน้นความแข็งแรงและได้มาตรฐาน\n\nทุกขั้นตอนดูแลอย่างใกล้ชิดจนส่งมอบงาน พร้อมให้คำแนะนำเรื่องการวางระบบพื้นถนน ลานตู้ และโครงสร้างที่เหมาะกับธุรกิจ ช่วยให้คุณได้พื้นที่ใช้งานที่มีคุณภาพ',
